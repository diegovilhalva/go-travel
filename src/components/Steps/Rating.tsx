...
const Rating = ({className,img,name,rating}:RatingProps) => {
  return (
    ...
    whileInView={{opacity:1,y:0,scale:1}} viewport={{once:true,amount:1}}  transition={{duration:0.5,ease:"easeInOut"}} className={`absolute flex gap-x-2.5 rounded-xl  bg-white/85 py-3.5 pr-5 pl-3  drop-shadow-[0px_4px_30px_rgba(0,0,0,0.12)] backdrop-blur-3xl ${className}`} >
