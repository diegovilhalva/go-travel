            ...
            <div className="border-y-grey-500/40 m-auto flex max-w-389 items-center justify-between gap-x-28 border-y-1 py-26 max-2xl:gap-x-20 max-2xl:py-20 max-xl:gap-x-10 max-xl:py-16 max-lg:max-w-lg max-lg:flex-col max-lg:gap-y-16 max-lg:border-none max-lg:py-0">
                ...
                <form className="flex basis-150 flex-col max-lg:basis-auto">
                    <label className="max-3xl:mb-7 mb-8 max-md:mb-8">
                        ...
                        <input type="text" name="fullName" value={values.fullName} onChange={handleChange} minLength={2} maxLength={50} placeholder="John Doe" className={`placeholder:text-grey-400 w-full rounded-lg bg-white py-3.5 pl-4 transition-all duration-200 placeholder:font-light focus:outline-1 disabled:opacity-50 max-sm:py-4 max-sm:text-sm ${errors.fullName && "outline-red"}`} required />
                        <AnimatePresence>
                    ...
                    <label className="max-3xl:mb-11.5 mb-12 max-md:mb-16">
                        ...
                        <input type="email" name="email" value={values.email} onChange={handleChange} minLength={5} maxLength={100} placeholder="email@example.com" className={`placeholder:text-grey-400 w-full rounded-lg bg-white py-3.5 pl-4 transition-all duration-200 not-hover:transition-none placeholder:font-light focus:outline-1 disabled:opacity-50 max-sm:py-4 max-sm:text-sm ${errors.emailAddress && "outline-red"}`}
            required />
                        <AnimatePresence>
                    ...
                    <div className="flex flex-wrap item-center justify-between gap-x-8 gap-y-8">
                        <label className="text-grey-800 flex cursor-pointer items-center 
                        gap-x-1.5">
                            <button className="flex size-5 cursor-pointer items-center justify-center rounded-xs bg-white p-1 disabled:opacity-50 max-xl:size-4.5" type="button" onClick={() => setIsChecked(!isChecked)}>
